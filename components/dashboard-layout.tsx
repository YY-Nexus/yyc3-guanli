    ...
    <div className="relative group">
      <Link
        ...
        className={cn(
          ...
          "hover:shadow-xl hover:scale-105 hover:-translate-y-0.5 transform-gpu",
          isActive
...
function SubNavItem({
  ...
  return (
    <Link
      href={href}
      className={cn(
        "sidebar-nav-sub flex items-center rounded-lg px-3 py-2 text-sm transition-all duration-300 hover:scale-105 hover:shadow-md transform-gpu",
        isActive
          ? "bg-blue-50 text-blue-700 font-medium shadow-sm border-l-2 border-blue-400"
          : "text-slate-500 hover:text-slate-700 hover:bg-slate-50",
      )}
    >
      {icon && <div className="w-4 h-4 mr-2 shrink-0 text-blue-700">{icon}</div>}
      <div
        className={cn(
    ...
    <ThemeProvider>
      <div className="flex min-h-screen bg-slate-50">
        ...
        >
          ...
          <div
            className={cn(
              "flex h-16 items-center border-b border-slate-200 transition-all duration-300 bg-blue-800",
          ...
          <div className="hidden lg:flex justify-end p-3 border-b border-slate-200">
            ...
            >
              {isCollapsed ? <ChevronRight className="h-4 w-4" /> : <ArrowBigLeftDashIcon className="h-4 w-4 text-blue-700" />}
            </Button>
          </div>
          ...
          {!isCollapsed && (
            <div className="p-4 border-t border-slate-200 bg-slate-50/30">
              <div className="text-center">
                ...
                <div className="text-sm text-blue-700 font-bold leading-8">YanYu Cloud Cube
</div>
        ...
        <div className={cn("flex flex-col flex-1 transition-all duration-300", isCollapsed ? "lg:pl-16" : "lg:pl-64")}>
          {/* 顶部导航栏 */}
          <header className="nav-header sticky top-0 z-10 flex h-16 items-center gap-4 border-b border-slate-200 px-6 bg-blue-800">
            <Button
              variant="ghost"
              size="icon"
            ...
            <div className="ml-auto flex items-center gap-2">
              <div className="text-xs hidden sm:block text-destructive-foreground">YanYu Cloud Cube Sharing E-center</div>
            </div>
          </header>
